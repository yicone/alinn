...
namespace HOT.SQLServerDAL
{
	...
	public class Order:IOrder
	{
		...
		public void Add(HOT.Model.Order model)
		{
			...
			parameters[7].Value = model.PerPoint;
			parameters[8].Value = model.EverydayPrice;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append("select OrderId,OrderName,UserId,AdId,StartDate,EndDate,AuditState,PerPoint,EverydayPrice,Price,Payment,CreateDate ");
