...
{
	/// <summary>
	/// 业务逻辑类SiteClass 的摘要说明。
	/// </summary>
	public class SiteClass
	{
		private readonly ISiteClass dal = DataAccess.CreateSiteClass();
		public SiteClass()
		{}
		#region  成员方法
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public HOT.Model.SiteClass GetModelByCache(int ClassId)
		{
			string CacheKey = "SiteClassModel-" + ClassId;
			...
			return (HOT.Model.SiteClass)objModel;
		}
