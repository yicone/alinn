<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZoneCategory.aspx.cs" Inherits="Web.ZoneCategory"
    EnableViewStateMac="false" MasterPageFile="../MasterPage/UserCommon.Master" Title="广告位分类" %>
...
<asp:Content ID="Content2" runat="Server" ContentPlaceHolderID="_mainContent">
                ...
                <br />
                  ...
                  <tr>
				   ...
				   <tr>
                    ...
                    <td>
                        <br />
                        <input id="btnLast" type="button" value="上一步" onclick="return doCheckAndBack();" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input id="btnNext" type="button" value="下一步：获取广告位代码" onclick="return doCheckAndSubmit('none');" /><br />
                        <br />
                        </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
    ...
    function doCheckAndBack(){
        ...
        document.forms[0].action = "Zone.aspx";
    ...
    function doCheckAndSubmit(returnPage){
		...
		document.forms[0].action = "ZoneDesigner.aspx";
		} else {
		   var kvp = {
		       classids: $("#<%= hdn_classids.ClientID %>").val(),
		       keywords: $("#<%= hdn_keywords.ClientID %>").val(),
		   ...
		   document.forms[0].action = "ZoneView.aspx";
		}
