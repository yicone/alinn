...
<body>
	...
	<td height="25" colspan="2"><div align="center">
		<asp:Button ID="btnAdd" runat="server" Text="¡¤ Ìá½» ¡¤" OnClick="btnAdd_Click" ></asp:Button>
		<asp:Button ID="btnCancel" runat="server" Text="¡¤ ÖØÌî ¡¤" OnClick="btnCancel_Click" ></asp:Button>
	</div></td></tr>
</table>
    </div>
    </form>
