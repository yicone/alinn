            ...
            <table width="100%">
                <tr>
                    <td style="width: 200px">
                        <asp:Button ID="btnGroupName" runat="server" Text='<%# Bind("GroupName") %>' OnClick="btnGroupName_Click" Width="112px" />
            </td>
                    <td style="width: 600px" align="right">
                        <asp:LinkButton ID="lbtnDeleteGroup" runat="server" 
                            Text="删除此广告组" CommandName="DeleteGroup" Width="100px"/>
