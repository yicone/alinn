<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Web.Default" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="notice" runat="server">
    <asp:GridView ID="gvNews" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="NewsId" DataSourceID="SqlDataSource1" ShowHeader="False" Width="100%">
        <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="classes" runat="server">
    <asp:DataList ID="dlClasses" runat="server" 
        onitemdatabound="dlClasses_ItemDataBound" RepeatColumns="4" 
        RepeatDirection="Horizontal" ShowFooter="False" Width="100%">
        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
            Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" 
            VerticalAlign="Top" />
        <HeaderTemplate>
            <div style="width:1002px;text-align:left; background-color:#6699FF; height:22px; padding-top:8px; padding-left:20px; font-size:18px;">广告分类</div>
        </HeaderTemplate>
        <ItemTemplate>
            <asp:Label ID="labClassName" runat="server" Text='<%# Bind("ClassName") %>' 
                Font-Size="Medium" ForeColor="#FF3300"></asp:Label>
            <br />
            <asp:DataList ID="dlSonClasses" runat="server" RepeatColumns="4" 
                RepeatDirection="Horizontal" RepeatLayout="Flow" Width="100%">
                <ItemTemplate>
            <a href="Ad/AdList.aspx?ClassId=<%#Eval("ClassId") %>"><%# Eval("ClassName") %></a> 
                </ItemTemplate>
            </asp:DataList>
        </ItemTemplate>
    </asp:DataList>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ecBox1" runat="server">
    <asp:GridView ID="gvecBox1" runat="server" AutoGenerateColumns="False" 
