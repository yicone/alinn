    ...
    <div>
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                ...
                <td height="25" width="*" align="left">
                    <asp:TextBox ID="txtDescription" runat="server" Rows="8" Columns="50" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td height="25" width="30%" align="right">
            ...
            <tr>
                ...
                <td height="25" width="*" align="left">
                    <asp:RadioButtonList ID="rblAgeType" runat="server" RepeatDirection="Horizontal">
