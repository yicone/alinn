<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZoneView.aspx.cs" Inherits="Web.ZoneView"
    EnableViewStateMac="false" MasterPageFile="/MasterPage/Member.Master" %>

<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="_mainContent">
    <div>
        <asp:FormView ID="FormView1" runat="server" Width="950px" DataSourceID="SqlDataSource1"
            OnDataBound="FormView1_DataBound">
            <ItemTemplate>
                <h3>
                    <span id="sec1" class="sec-toggler"></span>修改广告位信息 <span>
                        <asp:HyperLink runat="server" ID="linkEditZoneInfo">修改</asp:HyperLink></span>
                </h3>
                <dl>
                ...
                <h3>
                    <span id="sec2" class="sec-toggler"></span>广告位扩展信息 <span>
                        <asp:HyperLink runat="server" ID="linkEditZoneClass">修改</asp:HyperLink></span>
                </h3>
                <dl>
                ...
                <h3>
                    <span id="sec3" class="sec-toggler"></span>所属网站信息 <span>
                        <asp:HyperLink runat="server" ID="linkEditSiteInfo">修改</asp:HyperLink></span>
                </h3>
                <dl>
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
            SelectCommand="UP_GetZoneInfoExtForZoneView" SelectCommandType="StoredProcedure"
