                            ...
                            <tr class="tlist-item">
                                <td class="first" style="width: 95px; text-align: center;">
                                    <asp:LinkButton ID="LinkButton1" runat="server"
                                        CommandName="ToZoneView1" CommandArgument='<%# Eval("ZoneId") %>'><%# Eval("ZoneName") %></asp:LinkButton>
                                    <br />
                                    <span class="gray">
                                    ...
                                    <ul>
                                        <li>
                                            <asp:LinkButton ID="LinkButton2" runat="server"
                                                CommandName="ToZoneSellDetail" CommandArgument='<%# Eval("ZoneId") %>'>查看报表</asp:LinkButton></li>
                                        <li>&nbsp;</li>
                                        <li>
                                            <asp:LinkButton ID="LinkButton3" runat="server"
                                                CommandName="ToZoneView2" CommandArgument='<%# Eval("ZoneId") %>'>修改</asp:LinkButton></li>
                                        <li>&nbsp;</li>
                                        <li>
